...
const nextConfig = {
  ...
  env: {
    ...
    // API JWT credentials (try both NEXT_PUBLIC_ and regular env vars for AWS Amplify)
    API_JWT_USER: process.env.API_JWT_USER,
    API_JWT_PASS: process.env.API_JWT_PASS,
