...
const config = {
  ...
  "inlineSchemaHash": "e4468796d6cba82b4b733d46d60419df26a75ec14f3da078ae163a5215d0ddcc",
  "copyEngine": true
}
...
path.join(process.cwd(), "src/lib/generated/client/libquery_engine-rhel-openssl-3.0.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-rhel-openssl-1.0.x.so.node");
path.join(process.cwd(), "src/lib/generated/client/libquery_engine-rhel-openssl-1.0.x.so.node")
// file annotations for bundling tools to include these files
